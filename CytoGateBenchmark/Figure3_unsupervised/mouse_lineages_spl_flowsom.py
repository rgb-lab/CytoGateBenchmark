...
from ._gating_strategies import MOUSE_LINEAGE_GATE_MAPPING, MOUSE_LINEAGE_GATING_STRATEGY
...
OUTPUT_DIR = f"../figure_data/Figure_3/mouse_lineages_spl/flowsom_benchmark/"
